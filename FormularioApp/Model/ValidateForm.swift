...
class ValidateForm: NSObject {
    ...
    func checkCpfFieldValid(listOfTextFields: [UITextField]) -> Bool {
        var dictionaryOfTextFields: Dictionary<TypesOfTextFields, UITextField> = [:]
    ...
    func checkNumeroCartaoFieldValid(listOfTextFields: [UITextField]) -> Bool {
        var dictionaryOfTextFields: Dictionary<TypesOfTextFields, UITextField> = [:]
    ...
    func checkEmailFieldValid(listOfTextFields: [UITextField]) -> Bool {
        var dictionaryOfTextFields: Dictionary<TypesOfTextFields, UITextField> = [:]
